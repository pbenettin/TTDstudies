...
- A [table with all the studies](https://github.com/pbenettin/TTDstudies/blob/main/outputs/Table_studies.html)

- A [table with all the study sites](https://github.com/pbenettin/TTDstudies/blob/main/outputs/Table_sites.html)

- An [interactive map](https://github.com/pbenettin/TTDstudies/blob/main/outputs/Map.html) of the sites and studies
